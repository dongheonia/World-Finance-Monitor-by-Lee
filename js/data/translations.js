...
const translations = {
    ko: {
        ...
        footerRefresh4: "국채금리: 미국 1분(일별)·영국·독일·일본 30분(일별)·프랑스·한국 30분(월별)·중국 수동",
    ...
    en: {
        ...
        footerRefresh4: "Bond yield: US 1 min (daily) · UK/Germany/Japan 30 min (daily) · France/Korea 30 min (monthly) · China manual",
